    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/" element={<App />}>
          ...
          <Route path="/client/:clientId/" element={<DashboardClientScreen />}>
            {/* Route that renders all journal listings of client on client's portal */}
            <Route
              path="/client/:clientId/journals"
              element={<JournalList />}
            />
            {/* Route that renders all journal listings of client on client's portal */}
            <Route
              path="/client/:clientId/journals/:journalId"
              element={<JournalSingle />}
            />
            {/* Route that renders new journal form of client on client's portal */}
            <Route
              path="/client/:clientId/journal/new"
              element={<JournalForm />}
            />
            ...
            <Route
              path="/client/:clientId/therapist"
